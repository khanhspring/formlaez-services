...
public class FormPageResponseConverter implements Converter<JpaFormPage, FormPageResponse> {

    private final FormSectionResponseConverter formSectionResponseConverter;
    ...
    public FormPageResponse convert(@Nullable JpaFormPage source) {
        ...
        return FormPageResponse.builder()
                ...
                .code(source.getCode())
                .sections(formSectionResponseConverter.convert(source.getSections()))
                .build();
    }
