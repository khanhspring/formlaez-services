...
public class FormSectionResponseConvertor implements Converter<JpaFormSection, FormSectionResponse> {

    private final FormFieldResponseConvertor formFieldResponseConvertor;
    ...
    public FormSectionResponse convert(@Nullable JpaFormSection source) {
        ...
        return FormSectionResponse.builder()
                ...
                .fields(formFieldResponseConvertor.convert(source.getFields()))
                .build();
    }
